...
- `replay` - Traffic generated by sending requests using [Replay](/reference/features/testing/replay.md).
- `automate` - Traffic generated by an [Automate](/reference/features/testing/automate.md) campaign.
- `workflow` - Traffic generated by a [Workflow](/reference/workflows/workflows.md).
