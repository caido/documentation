...
- The `source` Namespace is available in [Search](/guides/search.md).
:::
...
- `replay` - Traffic generated by sending requests using [Replay](/guides/replay.md).
- `automate` - Traffic generated by an [Automate](/guides/automate.md) campaign.
- `workflow` - Traffic generated by a [Workflow](/guides/workflows.md).
