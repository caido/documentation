...
::: tip
Caido comes preinstalled on [Parrot Security](/app/guides/parrot_os.md) and [Athena OS](/app/guides/athena_os.md).
:::
...
3. Once Caido has been installed, launch Caido, and [continue to the setup instructions](/app/quickstart/setup.md).
...
4. Once Caido has been installed, launch Caido, and [continue to the setup instructions](/app/quickstart/setup.md).
...
If Caido is not launching and you are getting a FATAL error message, view the [Installation Issues](/app/troubleshooting/installation.md) troubleshooting guide for possible fixes.
:::
...
7. Once Caido has been installed, launch Caido, and [continue to the setup instructions](/app/quickstart/setup.md).
