...
- Both [log files](/app/guides/logs_viewing.md) that include the issue.
...
::: warning NOTE
Ensure to [enable debug mode](/app/troubleshooting/debugging.md) to assist with troubleshooting.
:::
