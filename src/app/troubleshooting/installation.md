...
<code><Icon icon="fas fa-screwdriver-wrench" /></code> If you encounter this error message after installing the [AppImage](/app/quickstart/linux#appimage) Caido package, either:
