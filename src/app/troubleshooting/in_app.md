...
<code><Icon icon="fas fa-screwdriver-wrench" /></code> Disable any Match & Replace rules, network configuration settings, and ensure your [proxy settings are configured correctly](/app/troubleshooting/startup.md#resolution-1).
...
<code><Icon icon="fas fa-screwdriver-wrench" /></code> Ensure you are viewing and working with the [raw](/app/guides/request_response_modes.md) representation of data.
...
<code><Icon icon="fas fa-screwdriver-wrench" /></code> Ensure the section pane wasn't [resized](/app/guides/ui.md#resizing-panes) inadvertently.
