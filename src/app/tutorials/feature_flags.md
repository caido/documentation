...
::: warning NOTE
To access the lab, navigate to [https://labs.caido.io/hubs/match-and-replace](https://labs.caido.io/hubs/match-and-replace), sign in with your account credentials, and **click** on the `Launch hub` button.
:::
...
1. With your proxy settings enabled, **click** on the <code> Open in new tab <Icon icon="fas fa-arrow-up-right-from-square" /></code> button to launch your lab instance.
...
::: warning NOTE
When copying values to match against from requests or responses, ensure to [view their raw representation](/app/guides/request_response_modes.md) to ensure correct formatting.
:::
