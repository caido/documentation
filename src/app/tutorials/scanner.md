...
::: info
The Scanner is available for [installation](/app/guides/plugins_installing.md) in the `Official` tab of the Plugin interface.
:::
...
This interface also includes rate limiting options and allows you to select the vulnerability severity levels that should generate [findings](/app/guides/workflows_findings.md) upon detection.
