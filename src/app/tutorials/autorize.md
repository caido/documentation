...
The `Filtering` tab options apply [scope presets](/app/guides/scopes_defining.md), [filter presets](/app/guides/filters_defining.md), or [HTTPQL](/app/reference/httpql.md) query statements to passive scans.
