...
::: info
Shift is available for [installation](/app/guides/plugins_installing.md) in the `Official` tab of the Plugin interface.
:::
...
<LabContainer>
Learn how to use this plugin in a hands-on, simulated training environment: <a href="https://labs.cai.do/shiftPayload.php">Shift Payload Lab</a>
</LabContainer>
