...
::: info
[Learn the difference between plugins and workflows in Caido.](https://developer.caido.io/app/concepts/workflow.md)
:::
...
::: info
[Learn more about the node data types.](/app/reference/workflow_data_types.md)
:::
