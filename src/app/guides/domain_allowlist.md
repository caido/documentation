...
For example, when utilizing a domain that resolves to `127.0.0.1` to [proxy local traffic](/app/guides/proxy_local.md), the domain must be added to the `Allowed Domains` list.
