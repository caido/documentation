...
To send traffic generated by WSL to the Caido desktop application running on your Windows host, select <code><Icon icon="fas fa-file-download" /> Export</code> from the [CA Certificate Management](/app/guides/ca_certificate_managing.html#ca-certificate-management) options.

Then, [change the listening address](/app/guides/listening_address.html#desktop-application) of the Caido desktop application to `All interfaces (0.0.0.0)`.
