...
::: tip
Deleted projects are unrecoverable unless a [backup file was created](/app/guides/projects_backups.md) prior to the account downgrade.
:::
...
- Or [create a backup file of the project](/app/guides/projects_backups.md), create a new Caido instance that [stores data outside of the default location](/app/guides/data_location.md), and [import the project backup file](/app/guides/projects_backups.md) to the instance.
