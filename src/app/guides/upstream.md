...
- `Included Hosts`/`Excluded Hosts`: Allows you to [define a scope preset](/app/guides/scopes_defining.md) to manage what traffic is sent upstream.
...
- Calls to [Caido's cloud server](/app/concepts/cloud.md) will not flow through additional proxies.
:::
