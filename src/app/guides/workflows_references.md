...
::: tip
View the [Workflow Node Data Types](/app/reference/workflow_data_types.md) reference to learn which input and output types are exact matches, compatible, and incompatible with one another.
:::
