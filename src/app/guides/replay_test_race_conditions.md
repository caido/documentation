...
You can create an new Pipeline by selecting **New Session** and choosing **Pipeline**.
...
<img alt="Adding Session into an HTTP Pipeline." src="/_images/replay_http_pipeline_add.png" center>
...
<img alt="Adding Session into an HTTP Pipeline." src="/_images/replay_http_pipeline_result.png" center>