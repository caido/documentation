...
Then, [import the CA certificate](/app/guides/ca_certificate_importing.md) of the new instance, configure your proxy settings to account for the new listening address, and navigate to the listening address in your browser to access the additional user interface.
