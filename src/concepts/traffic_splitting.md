...
| GET `http://127.0.0.1:8080/` HTTP/1.1 <br> Host: www.google.com | `127.0.0.1:8080` | API |  403 Forbidden | Host/IP is not allowed to connect to Caido <br> _View the [Domain Allowlist](/guides/domain_allowlist.md) guide._ |
