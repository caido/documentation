...
Caido Cloud is comprised of your account dashboard (_accessible at [https://dashboard.caido.io](https://dashboard.caido.io)_) and an API that handles [instance](/concepts/instances.md) registration and authentication.
...
- Our cloud services are currently hosted on on [Render](https://render.com) in their Oregon (_US_) region. Refer to Render's [Security and Trust](https://trust.render.com/) page for more information.
