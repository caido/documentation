...
A [traffic splitting algorithm](/concepts/traffic_splitting.md) recognizes that the request is intended for a destination server. The Caido CLI (_server component_) forwards the request and handles the corresponding response. 
