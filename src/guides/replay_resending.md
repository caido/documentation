...
<LabContainer message="Learn how to use this feature in hands-on, simulated training environments:" :labs="[{name: 'CSRF via Content-Type Lab', url: 'https://labs.cai.do/csrfContentType.php'}, {name: 'Reflected XSS Lab', url: 'https://labs.cai.do/xss.php'}, {name: 'SQL Injection Lab', url: 'https://labs.cai.do/sqlInjection.php'}, {name: 'SSTI Lab', url: 'https://labs.cai.do/ssti.php'}]" />
