---
description: "A step-by-step guide to using Caido on Exegol."
---

# Caido :handshake: Exegol
...
Caido now comes pre-installed in Exegol's free image (`free`), advanced images (`full`, `web`, `ad`, `nightly`), and private images.

## Launching Caido

To launch the Caido desktop application, enter the following command in you container terminal:

```bash
caido --no-sandbox
```

<img alt="Exegol." src="/_images/exegol.png" />

To launch the Caido CLI, enter:
